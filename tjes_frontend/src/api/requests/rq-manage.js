...
export let register = (from) => {
  return api.post('/register', from)
}

export let passwordfind = (from) => {
  return api.post('/passwordfind', from)
}
...
export let postSmsCode = (from) => {
  return api.post('/system/smsCode/register', from)
}
...
export let getCar = () => {
  return api.get('/system/car/list')
}
export let deletecar = (id) => {
  return api.post('/system/car/delete', {
    "id": id
  })
}
export let savecar = (from) => {
  return api.post('/system/car/save', from)
}
export let getRoom = () => {
...
export let getRoomByUserId = () => {
  return api.get('/system/user/room/list')
}

export let getCarByUserId = () => {
  return api.get('/system/user/car/list')
}

export let getUserInfoList = () => {
  return api.get('/system/user/information/list')
}
export let saveUserInfo = (from) => {
  return api.post('/system/user/information/save', from)
}
