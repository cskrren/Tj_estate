...
BEGIN;
INSERT INTO `sys_car` VALUES ('1', '奔驰', '任柯睿', '车位1', '1', '2021-03-03 07:17:31');
INSERT INTO `sys_car` VALUES ('2', '宝马', '任柯睿', '车位2', '0', '2021-03-03 07:17:32');
COMMIT;
-- ----------------------------
...
CREATE TABLE `sys_user_info` (
                                ...
                                `user_workplace` varchar(50) DEFAULT NULL COMMENT '用户工作地点',
                                 PRIMARY KEY (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

BEGIN;
INSERT INTO `sys_user_info` VALUES ('82ac1abea9c63a4362fa2a18355b6370', '男', '18', '123@mail.com', '同济大学');
INSERT INTO `sys_user_info` VALUES ('b43a9aea7ea4c45f96b241b602e92b2c', '女', '18', '123@mail.com', '同济大学');
COMMIT;
